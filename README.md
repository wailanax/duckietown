This branch will store additional resource files (libraries, system images, etc...) which are not a part of the source code but may be necessary for the duckiebots.
